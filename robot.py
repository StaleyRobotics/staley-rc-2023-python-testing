...
class Robot(wpilib.TimedRobot):
    ...
    def robotInit(self):
        ...
        self.motor9 = ctre.WPI_TalonFX(9)
    ...
    def teleopInit(self):
        ...
        self.leftDriveMotor1.setInverted(True)
    ...
    def teleopPeriodic(self):
        ...
        self.motor5.set(float(self.controller1.getYButton()) * 0.65)
        self.motor6.set(float(self.controller1.getRightTriggerAxis()) * 1)
        self.motor7.set(float(self.controller1.getRightBumper()) * 1)
        self.motor8.set(float(self.controller1.getRightBumper()) * 1)
        self.motor9.set(float(self.controller1.getAButton()) * 0.2)  #Climber Up
        self.motor9.set(float(self.controller1.getBButton()) * -0.2)  #Climber Down
        #self.motor5.set(self.controller1.getRightTriggerAxis())
